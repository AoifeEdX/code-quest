...
export default function Challenge({ count, handleAnswerButton, gameOver, questionAnswered, setQuestionAnswered }) {
    ...
    return (
        <div id='challenge'>
            <h2 className="text-center mt-4">Bootstrap Battle</h2>
            <h3 className="text-center mb-4">Question {count + 1}:</h3>
